...
import com.senither.hypixel.utils.RestActionUtil;
...
public class MessageFactory {
    ...
    public static PlaceholderMessage makeEmbeddedMessage(MessageChannel channel, MessageType type, MessageEmbed.Field... fields) {
        return makeEmbeddedMessage(channel, type.getColor(), fields);
    }

    public static PlaceholderMessage makeEmbeddedMessage(MessageChannel channel, Color color, MessageEmbed.Field... fields) {
