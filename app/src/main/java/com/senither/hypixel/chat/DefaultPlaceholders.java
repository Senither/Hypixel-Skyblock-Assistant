...
import com.senither.hypixel.utils.StringReplacementUtil;
...
class DefaultPlaceholders {
    ...
    private static String parseGuild(Guild guild, String message) {
        message = StringReplacementUtil.replaceAll(message, ":guildid", guild.getId());
        message = StringReplacementUtil.replaceAll(message, ":guildname", guild.getName());
